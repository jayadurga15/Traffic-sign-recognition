...
def init_gui():
    ...
    top.configure(background='#001f3f')

    label = Label(top, background='#001f3f', font=('arial', 15, 'bold'), foreground='white')
    sign_image = Label(top)
    heading = Label(top, text="Predict Traffic Sign", pady=20, font=('arial', 20, 'bold'))
    heading.configure(background='#001f3f', foreground='white')
    
    upload = Button(top, text="Upload an Image", command=upload_image, padx=10, pady=5)
    upload.configure(background='#001f3f', foreground='white', font=('arial', 10, 'bold'))
    ...
    exit_app.configure(background='#001f3f', foreground='white', font=('arial', 10, 'bold'))
...
def show_classify_button(file_path, model, classes):
    ...
    classify_b.configure(background='#001f3f', foreground='white', font=('arial', 10, 'bold'))
